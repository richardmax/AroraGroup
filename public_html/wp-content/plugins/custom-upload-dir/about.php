...
$plugin_title = 'Custom Upload Dir';
$plugin_changelog = 'http://wordpress.org/extend/plugins/custom-upload-dir/changelog/';	
$plugin_forum = 'http://wordpress.org/tags/custom-upload-dir?forum_id=10';
...
<?php echo "<div id='about'> 
	...
	<p>My name is <a href='{$author_site}'>Ulf Benjaminsson</a> and I've developed {$plugin_title} <a href='{$plugin_changelog}'>since 2007</a>. Nice to meet you! :)<p>
	...
	<h3>Known Issues:</h3> 
	<p>Uploads from <a href='https://play.google.com/store/apps/details?id=org.wordpress.android'>WordPress for Android</a> 
	and similar Apps (XMLRPC-clients), might not get sorted properly. <a href='http://wordpress.org/support/topic/search-and-mobile-apps-compatibility?replies=6#post-3837193'>Read more here</a>. 
	<br /><br />Bottom line: post-related placeholders only work if your client provides a post_id.</p>	
	<h3>Need Help?</h3> 
	<ol> 					
